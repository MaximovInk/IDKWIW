...
namespace OD
{
    public class AtmosphericFogRenderFeature : ScriptableRendererFeature
    {
        class CustomRenderPass : ScriptableRenderPass
        {
            ...
            int tempBufferID = Shader.PropertyToID("_TemporaryBuffer0");
            ...
            {
                cmd.GetTemporaryRT(tempBufferID, cameraTextureDescriptor.width, cameraTextureDescriptor.height);
            }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                cmd.Blit(source, tempBufferID, material, 0);
                cmd.Blit(tempBufferID, source);
