...
public class ModelGrass : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        initializeGrassShader = Resources.Load<ComputeShader>("Shaders/GrassChunkPoint");
        generateWindShader = Resources.Load<ComputeShader>("Shaders/WindNoise");
        cullGrassShader = Resources.Load<ComputeShader>("Shaders/CullGrass");
