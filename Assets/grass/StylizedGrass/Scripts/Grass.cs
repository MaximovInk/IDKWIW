...
public class Grass : MonoBehaviour
{
    ...
    public InstancePointData InstancePointData { get => instancePointData; set => instancePointData = value; }
    ...
    public float geometryNoiseScale = 1;
    [Space(10)]
    public bool enableRandomHeight = true;
    public Vector2 yScaleRange = new(0.75f, 1.25f);
    [Space(10)]
    public bool enableRandomRotation = true;
    public Vector2 rotRange = new(-15, 15);
    [Header("Interactions")]
    ...
    public void InititializeNEW()
    {


        if (instancePointData != null)
    ...
    {
        if (instancePointData == null) instancePointData = new();
    ...
    void InitializeBuffers()
    {
        ...
        if (instancePointData != null && instancePointData.TotalPointAmount > 0)
        {
    ...
    void InitializeRenderParams(out RenderParams renderParams)
    {
        ...
        if (instancePointData == null) return;
    ...
    void Update()
    {
        ...
        {
            if (instancePoints == null || instancePointsBuffer == null) return;

            if (instancePointsBuffer.count < instancePoints.Count) return;
    ...
    public void UpdateInstancePointsBuffer()
    {
        ...
        if (instancePointData.GetVisiblePoints(ref instancePoints))
        {
            if (instancePoints == null || instancePoints.Count == 0) return;
